...
[QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, MO(RGB_), KC_LALT, KC_LGUI, LWR_SPC, MO(LOWER), MO(RAISE), RSE_ENT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[GAME] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_DOT,  KC_LALT, KC_LGUI, KC_SPC,  MO(LOWER), MO(RAISE), KC_ENT,  KC_LEFT, KC_DOWN, KC_RGHT, TG(GAME)
),
...
[BOTH] = LAYOUT_preonic_grid(
  ...
  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, TG(GAME)
),
